 ...
 */
export declare function createPlugin(opts: StaticOptions): (bot: Bot) => void;
/**
 * Default loader function for the smoothLook plugin.
 * @param bot The bot to load the smoothLook plugin on.
 */
export declare function _loader(bot: Bot, debug?: boolean, _monkeyPatch?: boolean): void;
export declare function loader(bot: Bot): void;
export declare function monkeyPatch(bot: Bot, debug?: boolean): void;
